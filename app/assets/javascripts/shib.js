if(document.cookie && document.cookie.search(/_check_is_passive=/) >= 0){
    ...
    if (
        ...
        // Mark browser as being isPassive checked
          ...
          window.location.href = "https://" + window.location.hostname + "/Shibboleth.sso/Login?isPassive=true&target=" + encodeURIComponent("https://"+window.location.hostname + basePath);
  }
}
//-->
