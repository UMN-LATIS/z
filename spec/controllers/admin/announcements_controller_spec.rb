  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Admin::Announcement" do
        expect {
          post :create, params: {admin_announcement: valid_attributes}, session: valid_session
      ...
      it "redirects to the created admin_announcement" do
        post :create, params: {admin_announcement: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Admin::Announcement.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved admin_announcement as @admin_announcement" do
        post :create, params: {admin_announcement: invalid_attributes}, session: valid_session
        expect(assigns(:admin_announcement)).to be_a_new(Admin::Announcement)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_announcement" do
        announcement = Admin::Announcement.create! valid_attributes
        put :update, params: {id: announcement.to_param, admin_announcement: new_attributes}, session: valid_session
        announcement.reload
      ...
      it "assigns the requested admin_announcement as @admin_announcement" do
        announcement = Admin::Announcement.create! valid_attributes
        put :update, params: {id: announcement.to_param, admin_announcement: valid_attributes}, session: valid_session
        expect(assigns(:admin_announcement)).to eq(announcement)
      end
    ...
    context "with invalid params" do
      it "assigns the admin_announcement as @admin_announcement" do
        announcement = Admin::Announcement.create! valid_attributes
        put :update, params: {id: announcement.to_param, admin_announcement: invalid_attributes}, session: valid_session
        expect(assigns(:admin_announcement)).to eq(announcement)
      end
